...
const spinPool = {
    ...
    p1: [
        ...
        'The {{CITY}} {automotive|used car} market in {{YEAR}} is {favouring|rewarding} sellers who {move quickly|act now}. {Inventory levels|Available supply} for the {{MODEL}} {remain below average|are tight}, pushing {buyer demand|offers} higher. {Contact us today|Submit your details} to lock in {current market rates|today\'s top offer}.',
        ...
        'The {{MODEL}} {consistently ranks|regularly appears} among {Ontario\'s top 10|the most popular} {resale vehicles|used cars traded} in {{CITY}}. That {popularity|demand} directly {benefits|helps} you as a seller: {more competition|stronger buyer interest} means {higher offers|better prices} from {our buyer network|we buy cars}.',
    ...
    p3: [
        ...
        '{Market data|Transaction records} shows the {{MODEL}} is {one of the most|among the top} {actively traded|frequently purchased} used vehicles in {{CITY}}. {This means|That translates to} {multiple buyers|several purchasers} competing for {each available unit|every available car} — which {drives|pushes} our {offer higher|prices up} for {sellers like you|{{CITY}} residents}.',
        ...
        '{Ontario car buyers|Purchasers in {{CITY}}} {are actively seeking|want to buy} {{{CONDITION}} {{MODEL}} units|used {{MODEL}} vehicles}. {Supply is limited|Inventory is tight} relative to {demand|interest}, which {means|translates to} We Buy Cars {can offer|is able to pay} {stronger prices|more money} {right now|this week} than {in typical market conditions|during slower periods}.',
    ...
    market: [
        ...
        'Ontario\'s used vehicle market is one of the {most liquid|most active} in Canada — especially in {{CITY}} and the {GTA corridor|surrounding area}. A {{CONDITION}} {{MODEL}} {entering this market|listed for sale} through We Buy Cars {benefits from|receives} {immediate buyer matching|instant interest}, which is why we {commit to|offer} {same-day offers|quick quotes} and {same-day payment|fast payment}.',
        ...
        'The {{MODEL}} {has consistently ranked|continues to appear} {among the top|in the top 10} {most-purchased|highest-demand} used vehicles in {{{CITY}}|Ontario} for {multiple consecutive years|several years running}. {Sustained|Ongoing} {buyer demand|purchase interest} means {We Buy Cars|our team} can {reliably offer|consistently pay} {strong cash values|competitive prices} {regardless of|across all} {condition|vehicle state}.',
        '{{{CITY}}\'s|Ontario\'s} {automotive resale|used car} market {in {{YEAR}}|currently} {shows|displays} {resilience|strength} across {most vehicle categories|popular models}. The {{MODEL}}, as a {high-demand|well-regarded} {model|vehicle}, {benefits from|receives} {above-average buyer interest|strong purchase activity} — {which We Buy Cars|and we} {leverage|use} to {make you|offer you} {stronger offers|more competitive prices}.',
