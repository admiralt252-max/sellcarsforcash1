...
const DOMAIN = 'https://sellcarsforcash.ca'; // canonical domain — all URLs use this
...
const spinPool = {
    title: [
        ...
        '{Top Dollar|Best Price|Guaranteed Cash} for {{CONDITION}} {{MODEL}} in {{CITY}} | Sell Cars For Cash',
        ...
        'Cash for {{MODEL}} in {{CITY}} | {{CONDITION}} Cars | Sell Cars For Cash Ontario',
    ...
    heading: [
        ...
        'Why {{CITY}} {Owners|Sellers|Residents} Trust Sell Cars For Cash to {Purchase|Buy} Their {{MODEL}}',
        ...
        '{{CONDITION}} {{MODEL}} in {{CITY}}: {Sell|Cash Out} {Fast|Quickly|Today} with Sell Cars For Cash',
        ...
        '{{CITY}} Car Sellers: {Why|How} Sell Cars For Cash {Beats|Outperforms} Every {Dealer|Trade-In} Offer',
    ...
    p1: [
        'Selling a {{CONDITION}} {{MODEL}} in {{CITY}} privately means weeks of listing, UVIP paperwork, no-show test drives, and endless negotiating. Sell Cars For Cash {eliminates|removes} every one of those steps. Submit your details in 60 seconds, receive a {guaranteed|confirmed} cash offer by phone, and get paid {the same day|within hours} — no listings, no strangers, no stress.',
        ...
        'Ontario has one of the most active used-car markets in North America. A {{CONDITION}} {{MODEL}} in {{CITY}} attracts real demand from {private buyers|independent dealers|wholesalers} and {fleet operators|resellers}. When you sell through Sell Cars For Cash, you receive a {confirmed|guaranteed} cash offer based on {live GTA|real Ontario} transaction data — not {outdated book values|stale estimates}.',
        ...
        'Selling your {{CONDITION}} {{MODEL}} in {{CITY}} through a dealership typically means leaving {15–25%|thousands of dollars} of its value on the table. Trade-in quotes are designed to {subsidise dealer margins|pad the dealer\'s profit} — not maximise your return. Sell Cars For Cash pays {market-rate|full wholesale} cash directly to you, with {zero deductions|no hidden fees}.',
        'Got a {{CONDITION}} {{MODEL}} sitting in your {{CITY}} {driveway|garage|parking spot}? Whether you\'re {upgrading|relocating|moving on}, Sell Cars For Cash makes the sale {effortless|simple|stress-free}. Our licensed appraisers {come to you|visit your location}, assess the vehicle on-site, and {issue payment|transfer funds} before they leave.',
        ...
        'Sell Cars For Cash has {completed|processed} thousands of vehicle transactions across {{CITY}} and the {GTA|broader Ontario region}. Our streamlined {process|system} was built specifically for {{CITY}} sellers who want {maximum value|top dollar} without {dealership pressure|weeks of waiting}.',
        ...
        '{Thousands of|Hundreds of} {{CITY}} car owners have {chosen|used} Sell Cars For Cash over {private listings|dealership trade-ins} because {we pay more|our process is faster} and {we come to you|you never leave home}. The {{MODEL}} is a {model we purchase daily|high-demand vehicle in our network}.',
        ...
        'Sell Cars For Cash {purchases|acquires} {{CONDITION}} {{MODEL}} vehicles in {{CITY}} {seven days a week|every day}, including {evenings|weekends}. {No appointments needed|No prep required} — {we adapt|our team adjusts} to your {schedule|location} and complete the {full transaction|entire process} in {under 30 minutes|one visit}.',
        'Selling a {{CONDITION}} {{MODEL}} in {{CITY}} through {Kijiji|AutoTrader|private sale} means {paying listing fees|waiting weeks} and {dealing with tire-kickers|fielding lowball offers}. Sell Cars For Cash {bypasses all of that|eliminates every step} — {guaranteed offer|confirmed price}, {same-day pickup|on-site assessment}, {immediate payment|instant transfer}.',
        ...
        'Sell Cars For Cash {has purchased|has bought} {over 2,400|thousands of} vehicles {across Ontario|in {{CITY}} and the GTA}. {{CITY}} sellers {tell us|report} we {consistently outbid|routinely beat} {the competition|dealer trade-ins} — because our {direct-purchase model|process} {removes|eliminates} the {middleman|dealer margin} that {eats into|reduces} your {payment|offer}.',
        '{Stop waiting|Don\'t wait} for the {right buyer|perfect offer}. {Sell Cars For Cash|Our team} {is actively purchasing|currently buying} {{CONDITION}} {{MODEL}} vehicles in {{CITY}} {this week|right now}. {Submit your details|Call us today} and {get your offer|find out what your car is worth} in {60 seconds|under a minute}.',
    ...
    p2: [
        ...
        'Sell Cars For Cash {{CITY}} {appraisers|buyers} are {trained|certified} to {assess|evaluate} {all makes, models, and conditions|any vehicle}. {Your {{MODEL}}|The vehicle} is {inspected quickly|assessed on the spot} and {our offer|the quoted price} is {confirmed immediately|validated at pickup} — {no surprises|exactly as quoted}.',
        ...
        'Sell Cars For Cash {covers|operates in} {{CITY}} {and the surrounding area|with a local team}. {Response times|Pickup windows} are {among the fastest|the quickest} in {Ontario|the GTA} — {because we\'re local|our drivers are based nearby}, not {dispatching from|coming from} {across the province|far away}.',
    ...
    p3: [
        ...
        '{Selling in winter|Selling off-season|Timing your sale} {doesn\'t reduce|won\'t lower} our offer. {Sell Cars For Cash|Our team} purchases {{MODEL}} vehicles in {{CITY}} {year-round|all year} at {consistent|stable} {market rates|cash values}. {Seasonal demand fluctuations|Market timing} {affect private listings|slow down Kijiji}, not {our offers|what we pay}.',
        ...
        '{Sellers of|Owners with} {{CONDITION}} {{MODEL}} in {{CITY}} {are getting|are receiving} {stronger offers|more cash} right now. {Supply is limited|Inventory is tight}, which {means|translates to} Sell Cars For Cash {can offer|is able to pay} {stronger prices|more money} {right now|this week} than {in typical market conditions|during slower periods}.',
    ...
    market: [
        ...
        'Ontario\'s used vehicle market is one of the {most liquid|most active} in Canada — especially in {{CITY}} and the {GTA corridor|surrounding area}. Selling your {{CONDITION}} {{MODEL}} through Sell Cars For Cash {benefits from|receives} {immediate cash offers|instant payment}, which is why we {commit to|offer} {same-day offers|quick quotes} and {same-day payment|fast payment}.',
        ...
        'Sell Cars For Cash {monitors|tracks} {Ontario-wide|GTA-focused} {auction results|resale transactions} {weekly|in real time}. The {{MODEL}} {consistently fetches|regularly achieves} {strong prices|above-average values} across {all condition categories|every condition tier} — {our {{CITY}} offers|what we pay in your area} {reflect that data|are based on this intelligence}.',
        ...
        '{Ontario\'s|Canada\'s} {pre-owned vehicle|used car} market {is one of|remains} {the most liquid|highly active} in North America. {{CITY}} sits at {the centre of|within} the {most active|strongest} {regional market|buying zone} — {GTA demand|buyer activity} for the {{MODEL}} {supports|enables} Sell Cars For Cash to {make strong offers|pay competitive prices} {year-round|consistently}.',
        'The {post-pandemic|current} {Ontario used car|GTA pre-owned vehicle} market {continues to|still} favour {direct sellers|private sellers} over {trade-in|dealership} transactions. {Dealers|Franchised dealerships} are {tightening margins|reducing trade-in budgets} — which {increases|widens} the {advantage|gap} of {selling directly|going direct} through Sell Cars For Cash.',
        ...
        'Sell Cars For Cash {purchases|acquires} {{CONDITION}} {{MODEL}} {vehicles|units} across {{CITY}} at {market-rate|competitive} {cash prices|values}. Our {buyer network|wholesale connections} {spans|covers} {all of Ontario|the GTA and beyond}, {ensuring|guaranteeing} that the {offer you receive|price we pay} {reflects|captures} {the broadest possible|maximum} {buyer demand|market interest}.',
        ...
        'The {{MODEL}} {has consistently ranked|continues to appear} {among the top|in the top 10} {most-sold|highest-value} vehicles {sellers cash in|owners sell} in {{{CITY}}|Ontario} for {multiple consecutive years|several years running}. {Sustained|Ongoing} {seller activity|cash transactions} means {Sell Cars For Cash|our team} can {reliably offer|consistently pay} {strong cash values|competitive prices} {regardless of|across all} {condition|vehicle state}.',
        '{{{CITY}}\'s|Ontario\'s} {automotive resale|vehicle selling} market {in {{YEAR}}|currently} {shows|displays} {resilience|strength} across {most vehicle categories|popular models}. The {{MODEL}}, as a {high-demand|well-regarded} {model|vehicle}, {benefits from|receives} {above-average seller returns|strong cash offers} — {which Sell Cars For Cash|and we} {leverage|use} to {make you|offer you} {stronger offers|more competitive prices}.',
        ...
        '{The {{CITY}} market|In your area}, {{CONDITION}} {{MODEL}} {vehicles|cars} are {selling faster|moving more quickly} than the {Ontario average|provincial norm} in {{YEAR}}. {Buyer competition|Purchase demand} for {this specific model|the {{MODEL}}} is {elevated|high}, which {allows|enables} Sell Cars For Cash to {extend|make} {stronger|more competitive} {offers|cash prices} to {{{CITY}} sellers|owners like you}.',
        '{Economic conditions|Market forces} in {{YEAR}} {have created|generate} {a strong|an ideal} {seller\'s market|selling environment} for {{CONDITION}} {{MODEL}} {owners|sellers} in {{CITY}}. {Cash buyers|Direct purchasers} like Sell Cars For Cash {are actively competing|compete directly} for {available inventory|vehicles like yours} — {get your offer|find out what we\'ll pay} before {conditions shift|the market changes}.',
        'The {Ontario|Canadian} {used vehicle|pre-owned car} market {continues|remains} {active|strong} in {{CITY}} through {{YEAR}}. {Models like the {{MODEL}}|The {{MODEL}}} {attract|receive} {consistent|steady} {buyer interest|purchase demand} from {multiple market segments|various buyer types} — {all of which|all contributing to} {Sell Cars For Cash|us being able} to {pay|offer} {competitive|strong} {cash prices|amounts} in {{CITY}}.',
        '{Supply constraints|Limited inventory} for the {{MODEL}} {in {{CITY}}|across the GTA} {mean|translate to} {buyers are competing|strong buyer competition} for {available units|vehicles like yours}. {Sell Cars For Cash|Our team} {taps into|accesses} that {wholesale demand|buyer competition} directly — and {the result|that demand} is {a stronger offer|more cash} for you as the {seller|owner}.',
        '{Our market intelligence|Sell Cars For Cash\' data} for {{CITY}} {shows|indicates} {{CONDITION}} {{MODEL}} {values|prices} {averaging|typically reaching} {$PRICERANGE in {{YEAR}}|strong levels currently}. {This range|These values} {reflects|captures} {real buyer behaviour|actual transaction data}, not {theoretical estimates|generic online tools}.',
        '{Regardless of|No matter the} {{{CITY}}\'s seasonal|Ontario\'s market} {fluctuations|cycles}, Sell Cars For Cash {maintains|offers} {consistent|stable} {purchase prices|cash offers} for the {{MODEL}}. {Our wholesale network|The buyers in our network} {purchases year-round|buys in all seasons} — {meaning your offer|so your price} {doesn\'t depend on|isn\'t affected by} {timing|when you sell}.',
        '{{{CITY}}\'s|Ontario\'s} {most active|busiest} {period for used car|time for pre-owned vehicle} {transactions|sales} {aligns|coincides} with {current market conditions|right now in {{YEAR}}}. {This is|Now is} {a favourable time|an ideal moment} for {{CONDITION}} {{MODEL}} {sellers|owners} in {{CITY}} to {receive strong offers|get top dollar} — {contact|call} Sell Cars For Cash {today|now}.',
    ],
    local: [
        ...
        'Sell Cars For Cash {operates|runs} a {dedicated|full-time} {{{CITY}} pickup team|local collection fleet} — {not contractors|not freelancers}, but {our own|in-house} {licensed appraisers|trained buyers} who {know {{CITY}}|are familiar with your area}. {Local expertise|Area knowledge} means {faster dispatch|quicker arrivals} and {accurate, market-specific|locally-calibrated} {offers|pricing}.',
        ...
        'Sell Cars For Cash {has completed|has conducted} {vehicle purchases|transactions} in {every neighbourhood|all parts of} {{CITY}}. From {established residential areas|quiet suburbs} to {busy commercial streets|urban centres}, our {team|drivers} {navigate|know} {{CITY}} {efficiently|well} — {arriving on time|punctual arrivals} every {appointment|time}.',
        '{Our {{CITY}} team|Sell Cars For Cash {{CITY}}|Our local appraisers} {are available|operate} {7 days a week|every day of the week}, from {8am to 8pm|early morning to evening}. {Evening and weekend appointments|Off-hours slots} {are available at no extra charge|come with no premium} — because {we know|we understand that} {{CITY}} residents {have|lead} {busy lives|demanding schedules}.',
        ...
        '{{{CITY}} sellers|Local residents who sell to Sell Cars For Cash} {consistently rate|regularly give us} {our service highly|5-star feedback} for {speed and professionalism|fast, honest service}. {Our {{CITY}} team|Sell Cars For Cash} {prides itself on|is committed to} {arriving on time|punctuality}, {paying as quoted|honouring our offers}, and {leaving the seller|ensuring you\'re} {fully satisfied|completely happy}.',
        'We {buy all makes and models|purchase every type of vehicle} in {{CITY}} — not just the {{MODEL}}. {Our network|Sell Cars For Cash} {covers|handles} {everything from daily drivers|all vehicles from economy cars} to {luxury vehicles|high-end models} and {commercial vehicles|trucks and vans}. {The {{MODEL}} is particularly in demand|Your {{MODEL}} is a model we actively seek} in {{{CITY}}|your area}.',
        ...
        'Sell Cars For Cash {is committed to|prioritises} {serving {{CITY}}|{{CITY}} residents} with {the best possible|top-quality} {service and pricing|experience and offers}. {Our local {{CITY}} team|Sell Cars For Cash {{CITY}}} {handles|manages} {every transaction|all purchases} personally — {not call centres|direct service}, {not third-party agents|no outsourcing}, {just our own appraisers|just our trained team} {at your door|at your location}.',
        '{We\'ve served|Sell Cars For Cash has assisted} {{CITY}} {sellers|car owners} for {years|a significant period}, {building|earning} a {reputation|name} for {honest, fast|straightforward, quick} {vehicle purchases|car buying}. {Our {{CITY}} track record|Our local history} speaks for itself: {thousands of transactions|many completed sales}, {all completed as quoted|every one paid as promised}.',
...
function applySpins(raw, page, existingFiles) {
    ...
    const localSchema = JSON.stringify({
        ...
        name: 'Sell Cars For Cash',
        alternateName: 'Sell Cars For Cash Ontario',
    ...
    const faqSchema = JSON.stringify({
        ...
        mainEntity: [
            ...
            },
            {
                ...
                acceptedAnswer: { '@type': 'Answer', text: `Sell Cars For Cash completes most transactions the same day. You submit your details, receive a confirmed cash offer by phone, and we arrange on-site pickup and payment — often within hours.` }
            },
            {
                '@type': 'Question',
    ...
    // Meta description
    const metaDesc = `Sell your ${page.condition} ${page.model} in ${page.location} for top dollar. Sell Cars For Cash offers instant cash (${priceRange}), same-day payment, and on-site appraisal. Get your offer in 60 seconds.`;
...
<head>
  ...
  <title>All Pages — Sell Cars For Cash</title>
...
<head>
  ...
  <title>Page Not Found — Sell Cars For Cash</title>
...
<body class="bg-gray-50 min-h-screen flex flex-col">
  ...
  <header class="bg-gray-900 text-white py-4">
    <div class="max-w-5xl mx-auto px-4 flex items-center justify-between">
      <a href="/" class="text-xl font-bold tracking-tight">Sell Cars For Cash</a>
  ...
  <!-- Callback Modal -->
    <div id="modal404" class="fixed inset-0 bg-black bg-opacity-60 z-50 items-center justify-center p-4 hidden">
  ...
  <footer class="bg-gray-900 text-gray-400 text-center py-4 text-sm">
    &copy; ${new Date().getFullYear()} Sell Cars For Cash. Ontario, Canada.
  </footer>
